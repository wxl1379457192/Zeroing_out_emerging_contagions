...
dataset = readtable('E:/zeroCOVID_NPI/Rt_0709/codeV0803/1220dataset/Rt&smooth_NPI.csv',VariableNamingRule='preserve');
...
%%
%dataset = RtsmoothNPI;
outdir = 'E:/zeroCOVID_NPI/Rt_0709/codeV0803/SEIR_1220_SE';
...
writetable(Par,[outdir,'/IS1_Parameters_SEIR.xlsx'],'WriteRowNames',true)
