...
###################add temperature. humidity and vacciantion data########################
...
ID = read.csv(paste0(dir,"/1 Outbreak_information_all.csv"),stringsAsFactors = F)
...
cases.envir = do.call(rbind,lapply(split(cases.envir,cases.envir$city),function(c){
