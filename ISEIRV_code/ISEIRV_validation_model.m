function [Effect, total,precases,valcases, RMSE_val,NRMSE_val, R2_val] = ISEIRV_validation_model(data, NPIs, number, outdir)
...
writetable(cases,[outdir,char('/SEIR_simulation/'+string(data.VG(1))+string(number)+'.xlsx')],'WriteRowNames',true)
