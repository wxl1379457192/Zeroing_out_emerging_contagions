%clear
%clc
data = readtable('E:/zeroCOVID_NPI/Version0504/dataset/Rt&smooth_NPI.csv',VariableNamingRule='preserve');
...
%%
%dataset = RtsmoothNPI;
outdir = 'E:/zeroCOVID_NPI/Version0504/SEIR_simulation_P3';
...
for i = 1:size(index,1)
    ...
    L = [1,4,7];
    all= table();
    for x = 1:length(R0) %设定R0 分别为3，8, 13
        r = R0(x);
