...
%%
%dataset = RtsmoothNPI;
outdir = 'E:/zeroCOVID_NPI/Version0504/SEIR_validation';
...
valName  = {'MSE','RE_MSE','r2','VG','citycode','original_start','Predicted_cases','Real_cases','Label_q'};
valTypes = {'double','double','double','string','string','string','double','double','string'};
rowcolval = [size(index,1),9];
