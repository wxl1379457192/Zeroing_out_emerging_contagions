function [sim] = ISEIRV_realworld_model(data, NPI,Controls, par, tspan)
...
varNames  = {'Mean','CI05','CI95','citycode','original_start','Scenario'};
varTypes = {'double','double','double','string','string','string'};
rowcol = [maxlength,6];
