...
indir = "1025dataset"
casesISO = read.csv("dataset/New_cases_all_0910.csv",stringsAsFactors = F) 
...
fn = read.csv(paste0("dataset/Cityname.csv"),stringsAsFactors = F)
colnames(fn) = c("Cityname_CN","Cityname_EN")
f = merge(f,fn,by="Cityname_CN")

f = f[,c("Date","Cityname_EN","original_start","Label_q","VG",
         "Facial_Mask",
